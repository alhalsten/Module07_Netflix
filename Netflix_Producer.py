...
with open(input_file_name, 'r') as input_file:
    ...
    for row in reader:
        ...
        send_message_01("localhost","01-close", MESSAGE_01)
        send_message_02("localhost","02-open", MESSAGE_02)
        send_message_03("localhost","03-volume", MESSAGE_03)
