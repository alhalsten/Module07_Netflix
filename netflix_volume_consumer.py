...
def close_callback(ch, method, properties, body):
    ...
    try: 
        ...
        if len(close_deque) == 2:
            closealert = close_deque[1]/close_deque[0]
            if closealert < 0.50:
                print(alert)
...
def main(hn: str = "localhost", qn: str = "task_queue"):
    ...
    try:
        ...
        channel.basic_consume( queue=qn, on_message_callback=close_callback)
